...
사실 개발자를 목표로 한지는 꽤 되었고 개발을 혼자 독학하다 보니 동기부여도 부족하고 스스로 너무 늘어지는 것 같아 졸업하고 바로 부트캠프에 들어가고자 마음먹었다. 비전공자로서 개발자로 제대로된 경쟁력을 갖추기 위해서는 탄탄한 CS지식이 밑받침 되어야 된다고 생각해서 알아보던 와중 크래프톤 정글의 커리큘럼이 나에게 딱 맞다고 생각해 고민도 안하고 지원하게 되었다. (사실 SSAFY 떨어지고 지원함 ㅋ)

&nbsp;

지원 과정은 다음과 같다:  
**지원서 작성 -> 개별학습 -> 입학시험 -> 인터뷰 -> 최종 합격 발표**
